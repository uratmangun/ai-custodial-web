...
=======
    return (
        <main className="flex h-screen w-full flex-col justify-start bg-background">
            <section
                className="relative flex-grow w-full overflow-hidden py-20 lg:py-36 bg-gradient-to-r from-red-400 via-yellow-400 via-green-400 via-blue-400 to-purple-400">
                <motion.div
                    initial={{opacity: 0, y: 20}}
                    animate={{opacity: 1, y: 0}}
                    transition={{delay: 0.3, duration: 0.8}}
                ...
                >
                    ...
                    <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 max-w-3xl mx-auto mt-4">
                        Chat with ai and trade zora coins
                    </p>
                    <div className="flex flex-col gap-4 mt-8 items-center">
                        <div className="flex flex-row gap-4">
                            <Button variant="default" size="lg" asChild>
